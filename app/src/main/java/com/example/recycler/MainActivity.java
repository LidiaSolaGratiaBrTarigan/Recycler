...
public class MainActivity extends AppCompatActivity {
    ...
    public void takePicture(ImageCapture imageCapture) {
        ...
        imageCapture.takePicture(outputFileOptions, Executors.newCachedThreadPool(), new ImageCapture.OnImageSavedCallback() {
            ...
            public void onImageSaved(@NonNull ImageCapture.OutputFileResults outputFileResults) {
                // Menampilkan preview sementara dari gambar yang baru diambil
                Bitmap bitmap = BitmapFactory.decodeFile(file.getAbsolutePath());

                // Memeriksa orientasi gambar dan menyesuaikan orientasi jika perlu
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        // Menampilkan button "Send Image" setelah gambar diambil
                        findViewById(R.id.sendImageButton).setVisibility(View.VISIBLE);

                        // Menyembunyikan tampilan kamera setelah gambar diambil
                        previewView.setVisibility(View.GONE);
                    }
                });


                // Mengatur ulang tampilan kamera dan menyimpannya kembali
                startCamera(cameraFacing);
            }
    ...
    // Metode untuk mendapatkan orientasi gambar dari file
    ...
    // Metode untuk memutar bitmap sesuai dengan orientasi yang diberikan
